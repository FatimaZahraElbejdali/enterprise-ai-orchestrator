...
CAPABILITY_OVERRIDES = {
    ...
    "odoo_count_records": {
        "capability": "odoo.generic_read_count",
        "permission_category": "odoo_read",
        "io_mode": "read",
        "required_parameters": ["read_plan"],
        "allowed_models": sorted(SAFE_ODOO_READ_MODELS),
    ...
    "odoo_group_by": {
        "capability": "odoo.generic_read_group_by",
        "permission_category": "odoo_read",
        "io_mode": "read",
        "required_parameters": ["model_name", "group_by"],
        "allowed_models": sorted(SAFE_ODOO_READ_MODELS),
    },
...
TOOLS = {
    ...
    "odoo_count_records": {
        "description": "Safely count allowlisted Odoo records using a validated read plan.",
        "system": "odoo",
        "risk_level": "low",
        "requires_approval": False,
    },
    "odoo_group_by": {
        "description": "Safely group allowlisted Odoo records by a validated field.",
        "system": "odoo",
        "risk_level": "low",
        "requires_approval": False,
    },
    ...
    "odoo_list_customer_invoices": {
        "description": "Safely list Odoo customer invoices using validated account.move filters.",
        "system": "odoo",
        "risk_level": "low",
        "requires_approval": False,
    },
    "odoo_search_analytic_account": {
        "description": "Safely search Odoo analytic accounts by business reference or name.",
        "system": "odoo",
        "risk_level": "low",
        "requires_approval": False,
    },
    "odoo_get_analytic_account_details": {
        "description": "Safely read Odoo analytic account details by business reference, name, or resolved ID.",
        "system": "odoo",
        "risk_level": "low",
        "requires_approval": False,
    },
